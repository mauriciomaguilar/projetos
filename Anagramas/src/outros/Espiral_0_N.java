...
public class Espiral_0_N {
	...
	public static void main(String[] args) {
		...
		repeticoes = JOptionPane
				.showInputDialog("Digite o valor de N para o calculo de O(n)");
			...
			if (entrada.trim().length() != 0) {
				JOptionPane.showMessageDialog(
						...
						"O ponto "
								+ entrada.trim()
								+ " corresponde ao "
								+ ep.calculaEspiral(new Integer(entrada.trim()), new Integer (repeticoes.trim())));
			}
		}
